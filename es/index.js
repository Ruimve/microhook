...
function useLoading(request) {
    const [response, setResponse] = reactExports.useState({ loading: false, data: null });
    const wrapRequset = reactExports.useCallback((...args) => __awaiter(this, void 0, void 0, function* () {
...
function useRestHeight(props) {
    ...
    const [restHeight, setRestHeight] = reactExports.useState(0);
